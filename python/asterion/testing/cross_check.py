...
#: A bound request object accepted by both matchers.
Request: TypeAlias = (
    "asterion.NewOrderRequest | asterion.CancelOrderRequest | asterion.ReplaceOrderRequest"
)
    ...
    *,
    ...
    for _ in range(n_ops):
        ...
        if roll < 0.62:
            ...
            coid = rng.choice(used_coids) if used_coids and rng.random() < 0.06 else fresh_coid()
            op = new_order(
                coid,
                side,
                order_type,
