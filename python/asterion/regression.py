...
Benchmark results are host-dependent. Comparing two JSON files is meaningful only
when both were produced on comparable hardware under comparable conditions.
"""
