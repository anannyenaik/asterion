"""Contract checks for the recorded-public-L2 ONNX artefact.

Covers the metadata schema, the window and shape contract, the normalisation
metadata, the content checksums of the model, source dataset and expected
fixtures, and, when ``onnxruntime`` is importable, that the committed model
reproduces its recorded expected output.
"""
