...
Asterion evaluates recorded and simulated trading-system workloads. It has no exchange or broker order connectivity and places no orders. An opt-in utility records unauthenticated public REST depth snapshots for offline fixtures. The reported measurements concern systems behaviour, not trading profitability or predictive quality.
