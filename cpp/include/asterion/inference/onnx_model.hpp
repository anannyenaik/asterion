...
// ONNX Runtime inference backend. Compiled only when the optional ONNX Runtime
// dependency is enabled with -DASTERION_USE_ONNXRUNTIME. The deterministic
// LinearModel is the default and fallback.
