...
This orchestrator combines the corpus generator, benchmark runner and result
comparison:
...
Latency and throughput are specific to the host that runs the script. Generated
corpora are deterministic stress workloads; large corpora are never committed,
only this script and the small validation fixtures.
"""
